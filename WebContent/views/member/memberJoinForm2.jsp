...
<body onload="email1();">
	...
	<div class="container">
		<div class="tableArea">
			<div id="">
				<form id="joinForm" name="joinForm" action="<%= request.getContextPath() %>/InsertMemberServlet2" method="post" onsubmit="return joinValidate();"
					...
					<div class="xans-element- xans-member xans-member-edit">
						...
						<div class="boardWrite">
							<table border="1" summary="">
                                ...
                                <td id="dog_su"><input type="number" id="dogsu" name="dogsu" value="0"> 마리</td>
								<script>
									if(dogsu)
