...
<body>
	...
	<form id="BoardForm"  action="<%=request.getContextPath() %>/IMGInsertServlet" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="boardView">
                                <table border="1" summary="">
                                    ...
                                    <tbody>
                                         <tr>
                                            <th>제목 </th>
                                            <td><input type="text" size="125" id="titleInput" name="title"> </td>
                                        </tr>
                                        <tr>
                                            <th id="writer">작성자 </th>
				...
				<div class="rest-img border float-left">
					<div class="rest-img1 border" id="rest-img1"><img src="<%= request.getContextPath() %>/resources/board/image/clickpng.png" id="rest-img-1" width="100%" height="100%"></div>
					<div class="rest-img2 border" id="rest-img2"><img src="<%= request.getContextPath() %>/resources/board/image/clickpng.png" id="rest-img-2" width="100%" height="100%"></div>
					<div class="rest-img3 border" id="rest-img3"><img src="<%= request.getContextPath() %>/resources/board/image/clickpng.png" id="rest-img-3" width="100%" height="100%"></div>
				</div>
				<br clear="both">
				...
				<input type="file" class="hidden" id="rest-img3-btn" onchange="loadImg(this,4)" name="rest-img3">
                                                ...
                                                <br>
                                                <br>
                                                   <textArea cols="125" rows="10" name="content" style="resize:none" placeholder="여러분과 반려견의 스토리를 자랑해보세요!"></textArea>
                                                   <br>
