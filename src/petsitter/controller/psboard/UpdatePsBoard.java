...
/**
 * Servlet implementation class UpdatePsBoard
 */
@WebServlet("/UpdatePsBoard")
public class UpdatePsBoard extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePsBoard() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) { //multipartContent일때
			...
			int result = new PsBoardInfoService().updatePsBoard(pb,fileList,psBoardNo);
